...
class tile_image
{
  ...
  public:
     ...
     */
    void paste(epng::png& canvas, int start_x, int start_y, int resolution) const;
  ...
  private:
    ...
    * 
    */
    epng::rgba_pixel scaled_pixel(double start_x, double endX, double startY, double endY) const;
    epng::rgba_pixel scaled_pixel(int start_x, int endX, int startY, int endY) const;
};
